<{extends file="store-backend/extends/main.block.tpl"}>
		...
		<div class="widget">
			<div class="widget-simple">
				...
				<h4 class="widget-content text-right animation-hatch">
					<a href="<{'store/order?'|url}>base=&filters[created_at][min]=<{date("Y-m-d")}>&filters[created_at][max]=<{date("Y-m-d",strtotime("+1 days"))}>"><{$_data.today_cnt}> <strong>订单</strong></a>
					<small>今日订单</small>
				</h4>
			</div>
		</div>
	...
	<div class="col-sm-6 col-md-4">
		...
		<div class="widget">
			<div class="widget-simple">
				...
				<h4 class="widget-content text-right animation-hatch">
					<a href="<{'store/order?'|url}>base=&filters[created_at][min]=<{date("Y-m-d")}>&filters[created_at][max]=<{date("Y-m-d",strtotime("+1 days"))}>"><strong>¥</strong> <{$_data.today_income}></a>
					<small>今日收入</small>
				</h4>
			</div>
		</div>
		...
		<div class="widget">
			<div class="widget-simple themed-background-dark">
				...
				<h4 class="widget-content widget-content-light text-right animation-hatch">
					<a href="<{'store/order?'|url}>base=&filters[created_at][min]=<{date("Y-m-01")}>&filters[created_at][max]=<{date("Y-m-01",strtotime("+1 month"))}>"><{$_data.month_cnt}> <strong>订单</strong></a>
					<small>月订单</small>
				</h4>
			</div>
		</div>
	...
	<div class="col-sm-6 col-md-4">
		...
		<div class="widget">
			<div class="widget-simple themed-background-dark-fire">
				...
				<h4 class="widget-content widget-content-light text-right animation-hatch">
					<a href="<{'store/order?'|url}>base=&filters[created_at][min]=<{date("Y-m-01")}>&filters[created_at][max]=<{date("Y-m-01",strtotime("+1 month"))}>" class="themed-color-fire"><strong>¥</strong> <{$_data.month_income}></a>
					<small>月收入</small>
				</h4>
			</div>
		</div>
		...
		<div class="widget">
			<div class="widget-advanced">
				...
				<div class="widget-main">
					...
					<div class="text-center"><a href="<{'store/order'|url}>">更多..</a></div>
				</div>
				<!-- END Widget Main -->
			</div>
		</div>
