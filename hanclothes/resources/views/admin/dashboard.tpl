			...
			<div id="page-content">
								...
								<div class="row text-center">
									<div class="col-xs-4 col-sm-3">
										<h2 class="animation-hatch">
											￥<strong><{$_data.sell_total_money}></strong><br>
											<small><i class="fa fa-thumbs-o-up"></i> 总销售</small>
										</h2>
									</div>
									<div class="col-xs-4 col-sm-3">
										<h2 class="animation-hatch">
											<strong><{$_data.order_total_cnt}></strong><br>
											<small><i class="fa fa-heart-o"></i> 总订单</small>
										</h2>
									</div>
									<div class="col-xs-4 col-sm-3">
										<h2 class="animation-hatch">
											<strong><{$_data.product_total_cnt}></strong><br>
											<small><i class="fa fa-calendar-o"></i> 商品数</small>
										</h2>
									</div>
									<!-- We hide the last stat to fit the other 3 on small devices -->
									<div class="col-sm-3 hidden-xs">
										<h2 class="animation-hatch">
											<strong><{$_data.user_total_cnt}></strong><br>
				...
				<div class="row">
					<div class="col-sm-6 col-lg-3">
						<!-- Widget -->
						<a href="<{'admin/order?'|url}>base=&filters[created_at][min]=<{$_week_start}>" class="widget widget-hover-effect1">
							<div class="widget-simple">
								<div class="widget-icon pull-left themed-background-autumn animation-fadeIn">
									<i class="gi gi-charts"></i>
								</div>
								<h3 class="widget-content text-right animation-pullDown">
									+ <strong>￥<{$_data.sell_week_money}></strong><br>
									<small>本周销售</small>
								</h3>
							</div>
						</a>
					...
					<div class="col-sm-6 col-lg-3">
						...
						<a href="<{'admin/order?'|url}>base=&filters[created_at][min]=<{$_week_start}>" class="widget widget-hover-effect1">
							<div class="widget-simple">
								...
								<h3 class="widget-content text-right animation-pullDown">
									+ <strong><{$_data.order_week_cnt}></strong><br>
									<small>本周订单数</small>
								</h3>
							</div>
						</a>
					...
					<div class="col-sm-6 col-lg-3">
						<!-- Widget -->
						<a href="<{'admin/product?'|url}>base=&filters[created_at][min]=<{$_week_start}>" class="widget widget-hover-effect1">
							<div class="widget-simple">
								<div class="widget-icon pull-left themed-background-fire animation-fadeIn">
									<i class="gi gi-shopping_cart"></i>
								</div>
								<h3 class="widget-content text-right animation-pullDown">
									+ <strong><{$_data.product_week_cnt}></strong>
									<small>本周商品</small>
								</h3>
							</div>
						</a>
					...
					<div class="col-sm-6 col-lg-3">
						<!-- Widget -->
						<a href="<{'admin/member?'|url}>base=&filters[created_at][min]=<{$_week_start}>" class="widget widget-hover-effect1">
							<div class="widget-simple">
								<div class="widget-icon pull-left themed-background-amethyst animation-fadeIn">
									<i class="gi gi-qrcode"></i>
								</div>
								<h3 class="widget-content text-right animation-pullDown">
									+ <strong><{$_data.user_week_cnt}></strong>
									<small>本周用户</small>
								</h3>
							</div>
						</a>
