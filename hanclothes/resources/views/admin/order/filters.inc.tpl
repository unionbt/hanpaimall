...
<form action="<{'admin'|url nofilter}>/<{block "name"}><{/block}>/" method="GET" class="form-bordered form-horizontal">
	...
	<div class="form-group col-sm-4">
		...
		<div class="col-md-9">
			<select name="filters[uid][in][]" class="suggest-model form-control" data-model="admin/store-user" data-text="{nickname}" data-term="nickname" data-placeholder="请输入用户昵称" value="<{$_filters.uid.in|default:[]|implode:','}>" multiple="multiple"></select>
		</div>
	</div>
	<div class="form-group col-sm-4">
