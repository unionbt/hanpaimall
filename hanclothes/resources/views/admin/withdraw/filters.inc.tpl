...
<form action="<{'admin'|url nofilter}>/<{block "name"}><{/block}>/" method="GET" class="form-bordered form-horizontal">
	...
	<div class="form-group col-sm-4">
		<label class="col-md-3 control-label" for="uid">用户真名</label>
		<div class="col-md-9">
			<select name="filters[uid][in][]" class="suggest-model form-control" data-model="admin/member" data-text="{realname}" data-term="realname" data-placeholder="请输入用户真名" value="<{$_filters.uid.in|default:[]|implode:','}>" multiple="multiple"></select>
		</div>
	</div>
	<div class="form-group col-sm-4">
