...
<form action="<{'admin'|url nofilter}>/<{block "name"}><{/block}>/" method="GET" class="form-bordered form-horizontal">
	...
	<div class="form-group col-sm-4">
		...
		<div class="col-md-9">
			<div class="input-group">
				<input type="text" id="title" name="filters[title][like]" class="form-control" placeholder="请输入关键词..." value="<{$_filters.title.like}>">
	...
	<div class="form-group col-sm-4">
		...
		<div class="col-md-9">
			<select name="filters[fid][in][]" class="suggest-model form-control" data-model="admin/factory" data-text="{name}" data-term="name" data-placeholder="请输入厂商名字" value="<{$_filters.fid.in|default:[]|implode:','}>" multiple="multiple"></select>
		</div>
	</div>
	<div class="form-group col-sm-4">
