...
<{block "filter"}>
<{include file="factory-backend/brand/filters.inc.tpl"}>
<{/block}>
...
<{block "table-td-options-plus"}>
	<a href="<{'factory'|url}>/product/?filters[bid][in][]=<{$item->getKey()}>" data-toggle="tooltip" title="产品列表" class="btn btn-xs btn-default"><i class="fa fa-shopping-cart"></i> 产品列表</a>
<{/block}>
