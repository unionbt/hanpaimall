<div class="form-group">
	...
	<div class="col-md-9">
		<select name="attr_id" id="attr_id" class="form-control select-model" value="<{$_data->attr_id}>" data-model="factory/product-attr" data-text="{name}" data-placeholder="请选择属性"></select>
	</div>
</div>
