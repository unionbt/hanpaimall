...
<form action="<{'factory'|url nofilter}>/<{block "name"}><{/block}>/" method="GET" class="form-bordered form-horizontal">
	...
	<div class="form-group col-sm-4">
		...
		<div class="col-md-9">
			<select name="filters[activity_type][in][]" id="activity_type" class="form-control select-model" data-model="factory/activity" data-text="{name}" value="<{$_filters.activity_type.in|default:[]|implode:','}>" multiple="multiple"></select>
		</div>
	</div>
	<div class="form-group col-sm-4">
