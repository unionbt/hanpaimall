...
class AuthController extends Controller
{
	...
	{
		$user = Auth::user();
		$this->_roles = $user->roles()->whereIn('roles.name',['admin','manager','owner','leader','factory','agent','store'])->get();
	...
	public function authenticateQuery(Request $request)
	{
		...
		{
			$user = Auth::user();
			$roles = $user->roles()->whereIn('roles.name',['admin','manager','owner','leader','factory','agent','store'])->get();
